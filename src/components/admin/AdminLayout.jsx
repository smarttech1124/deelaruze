...
const AdminLayout = () => {
  ...
  const menuItems = [
    ...
    { path: '/admin/hero-slides', icon: GalleryHorizontal, label: 'Homepage Hero' },
    { path: '/admin/roaring-records', icon: Disc3, label: 'Roaring Records' },
    { path: '/admin/stickers', icon: Sticker, label: 'Stickers' },
    { path: '/admin/collaborations', icon: Users2, label: 'Collaborations' },
    { path: '/admin/page-content', icon: LayoutTemplate, label: 'Page Content' },
